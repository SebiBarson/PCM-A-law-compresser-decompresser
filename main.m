...
figure('Name','PCM coder/decoder using A type compression',...
    ...
    uicontrol('Style','push',...
             ...
             'Callback','subplot(3,2,2);axis([lim_inf lim_sup min(xq) max(xq)]); subplot(3,2,4);axis([lim_inf lim_sup min(compressed) max(compressed)]); stem(compressed); subplot(3,2,6);axis([lim_inf lim_sup min(decompressed) max(decompressed)]);');
    uicontrol('Style','push',...
             'Units','normalized',...
